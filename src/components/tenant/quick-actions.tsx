...
const ALL_ACTIONS: TenantQuickAction[] = [
  ...
  },
  {
    ...
    icon: UserMinus,
    href: "/app/visitors?action=checkout",
    color: "bg-rose-50",
  ...
  },
  {
    ...
    icon: CalendarPlus,
    href: "/app/appointments?action=create",
    color: "bg-emerald-50",
  ...
  },
  {
    ...
    icon: Building2,
    href: "/app/departments?action=create",
    color: "bg-amber-50",
  ...
  },
  {
    ...
    icon: MapPin,
    href: "/app/branches?action=create",
    color: "bg-sky-50",
  ...
  },
  {
    ...
    icon: AlertTriangle,
    href: "/app/incidents?action=create",
    color: "bg-orange-50",
