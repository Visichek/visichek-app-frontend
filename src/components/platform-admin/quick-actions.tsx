...
const ALL_ACTIONS: QuickAction[] = [
  ...
  },
  {
    id: "create-plan",
    label: "Create Plan",
    description: "Define a new pricing plan with feature rules and usage limits",
    icon: Package,
  ...
  },
  {
    ...
    description: "Set up a new discount code with redemption limits and expiry",
    icon: Tags,
  ...
  },
  {
    id: "create-admin",
    label: "Add Admin",
    description: "Create another platform administrator account",
    icon: UserPlus,
    href: "/admin/tenants?action=add-admin",
    color: "bg-rose-50",
...
const STORAGE_KEY = "visichek_admin_action_order";
...
function orderActions(actions: QuickAction[], order: string[] | null): QuickAction[] {
  ...
  // Append any new actions that weren't in the saved order
...
export function QuickActions() {
  ...
  const resetOrder = useCallback(() => {
    ...
    persistOrder(ALL_ACTIONS.map((a) => a.id));
  }, []);
            ...
            <Tooltip key={action.id}>
              <TooltipTrigger asChild>
                <div
                  ...
                  tabIndex={0}
                  draggable={isEditing}
                  onDragStart={isEditing ? (e) => handleDragStart(e, action.id) : undefined}
                  onDragEnter={isEditing ? (e) => handleDragEnter(e, action.id) : undefined}
                  onDragLeave={isEditing ? (e) => handleDragLeave(e, action.id) : undefined}
                  ...
                  className={cn(
                    ...
                    "min-h-[72px]",
                    !isEditing && "cursor-pointer hover:border-primary/30 hover:shadow-sm",
                    isEditing && "cursor-grab active:cursor-grabbing",
                    isDragged && "opacity-40 scale-95",
                    isDragOver && "border-primary border-dashed bg-primary/5 scale-[1.02]",
