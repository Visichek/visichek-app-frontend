        ...
        <>
          ...
          <section>
            ...
            <div className="space-y-1">
              ...
              <SettingsSelect id="dateFormat" label="Date format" description="How dates appear across the platform" value={userSettings?.dateFormat ?? "DD/MM/YYYY"} onValueChange={(v) => handleUpdate({ dateFormat: v as DateFormat })} options={[{ value: "DD/MM/YYYY", label: "DD/MM/YYYY" }, { value: "MM/DD/YYYY", label: "MM/DD/YYYY" }, { value: "YYYY-MM-DD", label: "YYYY-MM-DD" }]} />
