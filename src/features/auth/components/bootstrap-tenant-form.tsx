...
/**
 * Dedicated page-level form for bootstrapping a new tenant.
 *
 * Replaces the modal at bootstrap-tenant-modal.tsx. Uses the shared
 * StepIndicator + useStepForm recipe to keep the multi-step flow consistent
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setValue(
                      "lawfulBasis",
                      v as BootstrapFormData["lawfulBasis"],
                      { shouldValidate: true },
                    )
                  }
                >
              ...
              <Input
                ...
                aria-describedby={
                  errors.dpoContactEmail
                    ? "bt-dpoContactEmail-error"
                    : undefined
                }
              />
              {errors.dpoContactEmail && (
                <p
                  id="bt-dpoContactEmail-error"
                  className="text-sm text-destructive"
                  role="alert"
                >
            ...
            <div className="flex items-start gap-3 rounded-md border border-border bg-muted/40 p-3">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setValue("crossBorderApproved", checked === true, {
                    shouldValidate: true,
                  })
                }
                className="mt-0.5"
              ...
              <div className="space-y-0.5">
                <Label
                  htmlFor="bt-crossBorderApproved"
        ...
        {stepForm.currentStep === 3 && (
          <div className="rounded-lg border border-border bg-muted/40 px-4 py-1">
            ...
            <ReviewRow
              ...
              value={values.countryOfHosting || "Not specified"}
            />
            <ReviewRow
              label="DPO Email"
              value={values.dpoContactEmail || "Not specified"}
            />
            <ReviewRow
              label="Cross-border Approved"
              value={values.crossBorderApproved ? "Yes" : "No"}
            />
