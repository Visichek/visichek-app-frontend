...
import { Percent, Target, CalendarRange, ClipboardCheck } from "lucide-react";
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div className="space-y-2">
                ...
                />
                {errors.code && (
                  <p id="discount-code-error" className="text-sm text-destructive" role="alert">
                    {errors.code.message}
                  </p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                {errors.name && (
                  <p id="discount-name-error" className="text-sm text-destructive" role="alert">
                    {errors.name.message}
                  </p>
                )}
              </div>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                />
                {errors.value && (
                  <p id="discount-value-error" className="text-sm text-destructive" role="alert">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="tenant">Tenant — one specific tenant</SelectItem>
                  <SelectItem value="plan">Plan — specific plans only</SelectItem>
                </SelectContent>
              </Select>
            </div>
            ...
            {values.scope === "tenant" && (
              <div className="space-y-2">
                ...
                />
                {errors.targetTenantId && (
                  <p id="discount-tenantId-error" className="text-sm text-destructive" role="alert">
        ...
        {stepForm.currentStep === 3 && (
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              />
              {errors.maxRedemptions && (
                <p id="discount-maxRedemptions-error" className="text-sm text-destructive" role="alert">
        ...
        {stepForm.currentStep === 4 && (
          <div className="rounded-lg border border-border bg-muted/40 px-4 py-1">
            ...
            <ReviewRow
              label="Type"
              value={values.type === "percentage" ? "Percentage (%)" : "Fixed Amount (₦)"}
            />
            <ReviewRow
              label="Value"
              value={
            ...
            <ReviewRow label="Valid From" value={values.validFrom || "No start date"} />
            <ReviewRow label="Valid Until" value={values.validUntil || "No expiry"} />
            <ReviewRow
